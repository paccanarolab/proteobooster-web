...
var COMPLEX_3_COLS_SUCCESS = function(data, stat, xhr){
    addComplexes3Cols('#complexes-container', data);
    complex_offset += data.length;
    removeButtonIfNotRelevant('complexes', data);
};
var COMPLEX_3_COLS_ERROR = function(xhr, stat, err){};
