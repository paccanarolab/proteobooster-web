# Generated by Django 4.1.7 on 2023-02-18 01:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='MITerm',
            fields=[
                ('mi_id', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('gene', models.CharField(db_index=True, max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stringency_value', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.stringencyvalue')),
                ('taxon_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.organism')),
            ],
        ),
        migrations.AddField(
